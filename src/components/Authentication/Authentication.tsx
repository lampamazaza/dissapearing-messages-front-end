      ...
      <div class="flex flex-col w-full max-w-[400px]  justify-center  p-6 bg-white rounded-lg border border-gray-200 shadow-md  dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="flex flex-col mt-4">
          <div>
            <label
              for="password"
              class=" text-gray-500 block mb-2 text-xsfont-medium text-gray-900 dark:text-gray-300"
            >
              Your password
            </label>
            <input
          ...
          <span class="text-[14px] text-gray-500 whitespace-nowrap text-center my-4">
            or
          </span>
